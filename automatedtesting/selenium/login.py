...
def add_cart(driver, n_items):
    for i in range(n_items):
        ...
        product = driver.find_element(By.CSS_SELECTOR,"div.inventory_details_name.large_size").text  # Get the name of the product from the page
...
def remove_cart(driver, n_items):
    for i in range(n_items):
        ...
        product = driver.find_element(By.CSS_SELECTOR,"div.inventory_details_name.large_size").text
